...
useEffect(() => {
  const fetchData = async () => {
    setLoading(true);
    const snapshot = await firebase.firestore().collection('CarData').where('services', '==', 'Pune National').get();
                    ...
                    <div className="hidden lg:block">
                        <div style={{ display: 'flex', flexDirection: 'row', }}>
                            <div style={{ width: '35%', margin: 'auto', fontFamily: 'Arial, sans-serif', backgroundColor: '#f2f2f2', padding: '20px', borderRadius: '5px', }}>
                                ...
                                <div>
                                    <p style={{ marginBottom: '10px', textAlign: 'center' }}><strong style={{ color: '#555', fontSize: '16px' }}>Service Type</strong> <br /> <span style={{ color: '#777', fontSize: '14px' }}>Pune National</span></p>
{/* 
