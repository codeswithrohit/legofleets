    ...
    const handleFilter = () => {
      const filteredData = travelData.filter((item) => {
        ...
        switch (selectedType.toLowerCase()) {
          case 'sedan':
            price = 3000 + Math.max(calculatedHours - 8, 0) * 300; // Base price for 8 hours, then 250/hour extra
            break;
          case 'minisuv':
            price = 4000 + Math.max(calculatedHours - 8, 0) * 400; // Base price for 8 hours, then 300/hour extra
            break;
          case 'suv':
            price = 4700 + Math.max(calculatedHours - 8, 0) * 450; // Base price for 8 hours, then 350/hour extra
            break;
          default:
            break;
        }
                    ...
                    <div className="hidden lg:block">
                        <div style={{ display: 'flex', flexDirection: 'row', }}>
                            <div style={{ width: '35%', margin: 'auto', fontFamily: 'Arial, sans-serif', backgroundColor: '#f2f2f2', padding: '20px', borderRadius: '5px', }}>
                                ...
                                <div>
                                    <p style={{ marginBottom: '10px', textAlign: 'center' }}><strong style={{ color: '#555', fontSize: '16px' }}>Service Type</strong> <br /> <span style={{ color: '#777', fontSize: '14px' }}>Mumbai Local</span></p>
