...
// Define your dropdownNavs array here...
const dropdownNavs = [
    {
        label: "Products", navs: [
            {
                                        ...
                                        <div className="mt-4 md:mt-0">
                                            <ul className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                                                {item?.navs.map((dropdownItem, idx) => (
                                                    <li key={idx}>
                                                        <p className="text-purple-900 text-sm font-semibold mb-2">{dropdownItem.label}</p>
                                                        <ul className='space-y-3'>
                                                            {dropdownItem.navs.map((navItem, idx) => (
                                                                <li key={idx} className="group">
                                                                    <Link href={navItem.path} className='flex items-center space-x-2'>
                                                                        <div className='w-12 h-12 bg-indigo-50 text-purple-900 rounded-full flex items-center justify-center'>
                                                                            {navItem.icon}
                                                                        </div>
                                                                        <div>
                                                                            <span className="text-gray-800 text-sm font-semibold">{navItem.title}</span>
                                                                            <p className='text-gray-600 text-sm'>{navItem.desc}</p>
                                                                        </div>
                                                                    </Link>
                                                                </li>
                                                            ))}
